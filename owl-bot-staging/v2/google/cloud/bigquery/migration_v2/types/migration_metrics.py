...
class TimeSeries(proto.Message):
    ...
    Attributes:
        ...
        points (Sequence[google.cloud.bigquery.migration_v2.types.Point]):
...
class Point(proto.Message):
    ...
    Attributes:
        interval (google.cloud.bigquery.migration_v2.types.TimeInterval):
            ...
            following points.
        value (google.cloud.bigquery.migration_v2.types.TypedValue):
