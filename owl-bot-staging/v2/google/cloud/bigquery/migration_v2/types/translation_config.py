...
class TranslationConfigDetails(proto.Message):
    ...
    Attributes:
        ...
        source_dialect (google.cloud.bigquery.migration_v2.types.Dialect):
            The dialect of the input files.
        target_dialect (google.cloud.bigquery.migration_v2.types.Dialect):
            The target dialect for the engine to
            translate the input to.
        name_mapping_list (google.cloud.bigquery.migration_v2.types.ObjectNameMappingList):
            The mapping of objects to their desired
            output names in list form.

            This field is a member of `oneof`_ ``output_name_mapping``.
        source_env (google.cloud.bigquery.migration_v2.types.SourceEnv):
...
class Dialect(proto.Message):
    ...
    Attributes:
        bigquery_dialect (google.cloud.bigquery.migration_v2.types.BigQueryDialect):
            The BigQuery dialect

            This field is a member of `oneof`_ ``dialect_value``.
        hiveql_dialect (google.cloud.bigquery.migration_v2.types.HiveQLDialect):
            The HiveQL dialect

            This field is a member of `oneof`_ ``dialect_value``.
        redshift_dialect (google.cloud.bigquery.migration_v2.types.RedshiftDialect):
            The Redshift dialect

            This field is a member of `oneof`_ ``dialect_value``.
        teradata_dialect (google.cloud.bigquery.migration_v2.types.TeradataDialect):
            The Teradata dialect

            This field is a member of `oneof`_ ``dialect_value``.
        oracle_dialect (google.cloud.bigquery.migration_v2.types.OracleDialect):
            The Oracle dialect

            This field is a member of `oneof`_ ``dialect_value``.
        sparksql_dialect (google.cloud.bigquery.migration_v2.types.SparkSQLDialect):
            The SparkSQL dialect

            This field is a member of `oneof`_ ``dialect_value``.
        snowflake_dialect (google.cloud.bigquery.migration_v2.types.SnowflakeDialect):
            The Snowflake dialect

            This field is a member of `oneof`_ ``dialect_value``.
        netezza_dialect (google.cloud.bigquery.migration_v2.types.NetezzaDialect):
            The Netezza dialect

            This field is a member of `oneof`_ ``dialect_value``.
        azure_synapse_dialect (google.cloud.bigquery.migration_v2.types.AzureSynapseDialect):
            The Azure Synapse dialect

            This field is a member of `oneof`_ ``dialect_value``.
        vertica_dialect (google.cloud.bigquery.migration_v2.types.VerticaDialect):
            The Vertica dialect
...
class TeradataDialect(proto.Message):
    ...
    Attributes:
        mode (google.cloud.bigquery.migration_v2.types.TeradataDialect.Mode):
...
class ObjectNameMappingList(proto.Message):
    ...
    Attributes:
        name_map (Sequence[google.cloud.bigquery.migration_v2.types.ObjectNameMapping]):
...
class ObjectNameMapping(proto.Message):
    ...
    Attributes:
        source (google.cloud.bigquery.migration_v2.types.NameMappingKey):
            The name of the object in source that is
            being mapped.
        target (google.cloud.bigquery.migration_v2.types.NameMappingValue):
...
class NameMappingKey(proto.Message):
    ...
    Attributes:
        type_ (google.cloud.bigquery.migration_v2.types.NameMappingKey.Type):
