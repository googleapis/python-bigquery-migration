...
class MigrationWorkflow(proto.Message):
    ...
    Attributes:
        ...
        tasks (Sequence[google.cloud.bigquery.migration_v2.types.MigrationWorkflow.TasksEntry]):
            ...
            workflow.
        state (google.cloud.bigquery.migration_v2.types.MigrationWorkflow.State):
...
class MigrationTask(proto.Message):
    ...
    Attributes:
        translation_config_details (google.cloud.bigquery.migration_v2.types.TranslationConfigDetails):
        ...
        state (google.cloud.bigquery.migration_v2.types.MigrationTask.State):
...
class MigrationSubtask(proto.Message):
    ...
    Attributes:
        ...
        state (google.cloud.bigquery.migration_v2.types.MigrationSubtask.State):
            Output only. The current state of the
            subtask.
        processing_error (google.rpc.error_details_pb2.ErrorInfo):
            Output only. An explanation that may be
            populated when the task is in FAILED state.
        resource_error_details (Sequence[google.cloud.bigquery.migration_v2.types.ResourceErrorDetail]):
        ...
        metrics (Sequence[google.cloud.bigquery.migration_v2.types.TimeSeries]):
