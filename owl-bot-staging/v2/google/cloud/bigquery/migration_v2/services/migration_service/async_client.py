...
from google.cloud.bigquery.migration_v2.services.migration_service import pagers
from google.cloud.bigquery.migration_v2.types import migration_entities
from google.cloud.bigquery.migration_v2.types import migration_error_details
from google.cloud.bigquery.migration_v2.types import migration_metrics
from google.cloud.bigquery.migration_v2.types import migration_service
...
class MigrationServiceAsyncClient:
    ...
    async def create_migration_workflow(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.migration_v2.types.CreateMigrationWorkflowRequest, dict]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            migration_workflow (:class:`google.cloud.bigquery.migration_v2.types.MigrationWorkflow`):
        ...
        Returns:
            google.cloud.bigquery.migration_v2.types.MigrationWorkflow:
    ...
    async def get_migration_workflow(self,
        ...
        .. code-block:: python
            ...
            def sample_get_migration_workflow():
                ...
                # Initialize request argument(s)
                request = migration_v2.GetMigrationWorkflowRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.bigquery.migration_v2.types.GetMigrationWorkflowRequest, dict]):
    ...
    async def list_migration_workflows(self,
        ...
        .. code-block:: python
            ...
            def sample_list_migration_workflows():
                ...
                # Initialize request argument(s)
                request = migration_v2.ListMigrationWorkflowsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.bigquery.migration_v2.types.ListMigrationWorkflowsRequest, dict]):
        ...
        Returns:
            google.cloud.bigquery.migration_v2.services.migration_service.pagers.ListMigrationWorkflowsAsyncPager:
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def delete_migration_workflow(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.migration_v2.types.DeleteMigrationWorkflowRequest, dict]):
    ...
    async def start_migration_workflow(self,
        ...
        .. code-block:: python
            ...
            def sample_start_migration_workflow():
                ...
                # Initialize request argument(s)
                request = migration_v2.StartMigrationWorkflowRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.bigquery.migration_v2.types.StartMigrationWorkflowRequest, dict]):
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def get_migration_subtask(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.migration_v2.types.GetMigrationSubtaskRequest, dict]):
                The request object. A request to get a previously
        ...
        Returns:
            google.cloud.bigquery.migration_v2.types.MigrationSubtask:
    ...
    async def list_migration_subtasks(self,
        ...
        .. code-block:: python
            ...
            def sample_list_migration_subtasks():
                ...
                # Initialize request argument(s)
                request = migration_v2.ListMigrationSubtasksRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.bigquery.migration_v2.types.ListMigrationSubtasksRequest, dict]):
                The request object. A request to list previously created
                migration subtasks.
            parent (:class:`str`):
        ...
        Returns:
            google.cloud.bigquery.migration_v2.services.migration_service.pagers.ListMigrationSubtasksAsyncPager:
