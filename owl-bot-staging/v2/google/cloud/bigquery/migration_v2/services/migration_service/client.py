...
class MigrationServiceClient(metaclass=MigrationServiceClientMeta):
    ...
    def create_migration_workflow(self,
        ...
        Args:
            ...
            parent (str):
                ...
                should not be set.
            migration_workflow (google.cloud.bigquery.migration_v2.types.MigrationWorkflow):
    ...
    def list_migration_workflows(self,
        ...
        Returns:
            google.cloud.bigquery.migration_v2.services.migration_service.pagers.ListMigrationWorkflowsPager:
    ...
    def list_migration_subtasks(self,
        ...
        Returns:
            google.cloud.bigquery.migration_v2.services.migration_service.pagers.ListMigrationSubtasksPager:
