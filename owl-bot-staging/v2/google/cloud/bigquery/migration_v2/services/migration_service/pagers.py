...
class ListMigrationWorkflowsPager:
    ...
    :class:`google.cloud.bigquery.migration_v2.types.ListMigrationWorkflowsResponse` object, and
    ...
    All the usual :class:`google.cloud.bigquery.migration_v2.types.ListMigrationWorkflowsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.bigquery.migration_v2.types.ListMigrationWorkflowsRequest):
                The initial request object.
            response (google.cloud.bigquery.migration_v2.types.ListMigrationWorkflowsResponse):
...
class ListMigrationSubtasksPager:
    ...
    This class thinly wraps an initial
    :class:`google.cloud.bigquery.migration_v2.types.ListMigrationSubtasksResponse` object, and
    provides an ``__iter__`` method to iterate through its
    ...
    All the usual :class:`google.cloud.bigquery.migration_v2.types.ListMigrationSubtasksResponse`
    attributes are available on the pager. If multiple requests are made, only
    the most recent response is retained, and thus used for attribute lookup.
    """
    def __init__(self,
        ...
        Args:
            method (Callable): The method that was originally called, and
                which instantiated this pager.
            request (google.cloud.bigquery.migration_v2.types.ListMigrationSubtasksRequest):
                The initial request object.
            response (google.cloud.bigquery.migration_v2.types.ListMigrationSubtasksResponse):
                The initial response object.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
                sent along with the request as metadata.
        """
