...
from google.cloud.bigquery.migration_v2.services.migration_service import (
...
def test_migration_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.bigquery.migration_v2.services.migration_service.transports.MigrationServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_migration_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.bigquery.migration_v2.services.migration_service.transports.MigrationServiceTransport.__init__"
    ) as Transport:
...
def test_migration_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.bigquery.migration_v2.services.migration_service.transports.MigrationServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
